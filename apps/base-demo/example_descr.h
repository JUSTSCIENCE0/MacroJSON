...
MJSON_OBJECT_BEGIN(ArrayExample)
    MJSON_ARRAY(int,                i32_arr)
    MJSON_ARRAY(double,             dbl_arr)
    MJSON_ARRAY(uint64_t,           u64_arr)
    MJSON_ARRAY(std::string,        str_arr)
    MJSON_ARRAY(SimpleExample,      smp_arr)
    MJSON_ARRAY(Level1Example,      lvl1_arr)
    MJSON_ARRAY(Level2Example,      lvl2_arr)
